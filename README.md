...
| Campo | Detalle |
|---|---|
| **Nombre del sistema** | Gestión de Venta de Vehiculos |
| **Grupo** | Grupo A |
| **Integrantes** | Alejandro P000024460, William P000013161, Rodolfo P000000555 |
| **URL del repositorio** | [Github](https://github.com/ph4nts3c/pswe04-gestion-de-vehiculos-2) |
| **Docente** | Juan Mauricio Leandro Jimenez |
| **Cuatrimestre** | 2026 — 2 |
| **Versión del documento** | 0.2 — Contexto del sistema, stakeholders, drivers arquitectónicos, escenarios de calidad (mín. 4) y vista de contexto C4. |
